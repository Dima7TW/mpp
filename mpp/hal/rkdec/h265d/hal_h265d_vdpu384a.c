...
static MPP_RET hal_h265d_vdpu384a_gen_regs(void *hal,  HalTaskInfo *syn)
{
    ...
    if (vdpu384a_setup_cur_stride_info(mframe, hw_regs, dxva_ctx->pp.chroma_format_idc)) {
...

    {
        ...
        case MPP_FRAME_THUMBNAIL_ONLY:
            ...
            vdpu384a_setup_down_scale(mframe, cfg->dev, &hw_regs->ctrl_regs, (void*)&hw_regs->comm_paras);
            break;
...
MPP_DEC_HAL_API_REGISTER(hal_h265d_vdpu384a)
